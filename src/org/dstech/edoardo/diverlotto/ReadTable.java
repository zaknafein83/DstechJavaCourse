...
import org.dstech.edoardo.diverlotto.PropertiesManagement;
...
public class ReadTable {
	 ...
	 */
		...
		public static void main(String[] args) throws Exception {
			...
			List<String> leggiFile = leggiFile(ReadTable.class.getResource("/resources/estrazionidellotto.csv").getPath());
