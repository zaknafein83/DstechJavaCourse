...
public class PersonaAgenda implements Serializable{
    ...
    public PersonaAgenda ()
    {
	 ...
	 public PersonaAgenda (int id, String nome, String cognome,int eta, String numeroTelefono, String email, Date dataInserimento){
	...
	public String toString() {
		return "Persona [nome=" + nome + ", cognome=" + cognome + ", eta=" + eta + ", numeroTelefono="
				+ numeroTelefono + ", email=" + email + ", dataInserimento=" + dataInserimento + "]";
	}

	
	public PersonaAgenda(String nome, String cognome, int eta, String numeroTelefono, String email, Date dataInserimento) {
		super();
		this.nome = nome;
		this.cognome = cognome;
		this.eta = eta;
