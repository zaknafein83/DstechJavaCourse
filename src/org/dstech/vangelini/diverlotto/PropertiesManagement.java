...
public class PropertiesManagement {
	...
	public PropertiesManagement() {
		try {
			prop = new Properties();
			//System.out.println("Caricamento Properties...");
			InputStream in = PropertiesManagement.class.getClassLoader().getResourceAsStream("org/dstech/vangelini/diverlotto/application.properties");
			prop.load(in);
			in.close();
