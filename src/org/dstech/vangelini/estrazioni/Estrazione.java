 ...
 * 
 */
package org.dstech.vangelini.estrazioni;
...
public class Estrazione implements Serializable{
	...
	public String toString() {
		return "Estrazione del "+data_estrazione+"\n"+numeri_estratti.get(0)+" "+numeri_estratti.get(1)+" "+numeri_estratti.get(2)+" "+numeri_estratti.get(3)+" "+numeri_estratti.get(4);
	}
