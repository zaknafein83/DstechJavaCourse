...
public class AgendaMain {
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		do{
			...
			switch(risposta){
				...
				break;
				case 2:
					aggiungiContatto(file, agenda, io);
				break;
				case 3:
					rimuoviContatto(file, agenda);
				break;
				case 4:
					modificaContatto(file, agenda, io);
				break;
				case 5:
					ricercaTelefonica(agenda, io);
				break;
				case 6:
				ricercaContatto(agenda, io);
				break;
				case 7:
	...
	public static void ricercaContatto(Agenda agenda, Scanner io) {
		...
		while(notStringContattoRicercato){
			...
			try{
				...
				notStringContattoRicercato = false;
			} catch(InputMismatchException exp){
	...
	public static void ricercaTelefonica(Agenda agenda, Scanner io) {
		boolean notStringTelefonoRicercato = true;
		String telefono_ricercato = "Non Impostato";
		while(notStringTelefonoRicercato){
			System.out.println("Inserisci Telefono: ");
			try{
				telefono_ricercato = io.next();
				if(Agenda.controlloTel(telefono_ricercato)){
	...
	public static void modificaContatto(LetturaSalvataggioFile file,
			...
			switch(risposta_nuova){
				...
				case 5:
					...
					while(notStringTelefonoDaModificare){
						...
						try{
							telDaModificare = io.next();
							if(Agenda.controlloTel(telDaModificare)){
	...
	public static void rimuoviContatto(LetturaSalvataggioFile file,
			Agenda agenda) throws IOException {
	...
	public static void aggiungiContatto(LetturaSalvataggioFile file,
			Agenda agenda, Scanner io) throws IOException {
